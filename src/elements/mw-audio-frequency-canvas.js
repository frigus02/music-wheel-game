...
class MusicWheelAudioFrequencyCanvas extends MwStateElementMixin(MusicWheelBaseCanvas) {
    static get DOT_SIZE() {
        return 2;
    }
    ...
    _onDraw(settings) {
        ...
        for (let i = 0; i < dataLength; i++) {
            ...
            settings.context.fillRect(i * barWidth, barValue, barWidth - 1, settings.height - barValue);
        }
...
customElements.define('mw-audio-frequency-canvas', MusicWheelAudioFrequencyCanvas);
